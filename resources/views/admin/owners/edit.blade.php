                ...
                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    ...
                    <div class="-m-2">
                        ...
                        <div class="relative">
                            ...
                            <div class="w-full bg-gray-100 bg-opacity-50 rounded focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                @isset($owner->shop->name){{ $owner->shop->name }}@endisset
                                @empty($owner->shop->name)<br>@endempty
                            </div>
                        </div>
                        </div>
                        <div class="p-2 w-1/2 mx-auto">
